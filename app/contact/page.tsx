  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-4 relative overflow-hidden">
      <div className="z-10 w-full max-w-4xl mx-auto mt-16">
        <h1 className="text-3xl text-center font-bold text-green-800 mb-8">Contact Me</h1>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="bg-white/10 backdrop-blur-sm">
            <CardHeader className="text-xl font-semibold">Get In Touch</CardHeader>
            <CardContent>
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <Link href="mailto:contact@hackabdullah.site" className="hover:text-green-800 transition-colors">
          ...
          <Card className="bg-white/10 backdrop-blur-sm">
            <CardHeader className="text-xl font-semibold">Send a Message</CardHeader>
            <CardContent>
              <form className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="name" className="mt-2 bg-emerald-900/20 backdrop-blur-sm border-none" placeholder="Your name" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="email" className="text-sm font-medium">
                    Email
                  </label>
                  <Input id="email" type="email" className=" mt-2 bg-emerald-900/20 backdrop-blur-sm border-none" placeholder="Your email" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-medium">
                    Message
                  </label>
                  <Textarea id="message" className="mt-2 bg-emerald-900/20 backdrop-blur-sm border-none min-h-[120px]" placeholder="Your message" />
                </div>
